...
typedef struct
{
  ...
  int waz, nftype, FMC, pattern, mon, jd, jd_min, pc, pdf;
  int time = 20;
  int nargs = 27;
...
public:
  ...
  bool get_burned(int period, int season, int NMsg, inputs df[], fuel_coefs *coef, arguments *args, weatherDF *wdf_ptr, bool &activeCrown, double perimeterCells);
