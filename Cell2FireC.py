...
class Cell2FireC:
    ...
    def __init__(self, args):
        ...
        self._Colors = {}
        self._FTypeCells = []
        self._FTypes2 = {'gr1':101, 'gr2':102, 'gr3':103, 'gr4':104, 'gr5':105, 'gr6':106, 'gr7':107,
                         'gr8':108, 'gs1':121, 'gs2':122, 'gs3':123, 'gs4':124, 'sh2':142, 'sh3':143,
                         'sh4':144, 'sh5':145, 'sh6':146, 'sh7':147, 'sh8':148, 'sh9':149, 'tu1':161,
                         'tu2':162, 'tu3':163, 'tu4':164, 'tu5':165, 'tl1':181, 'tl2':182, 'tl3':183,
                         'tl5':185, 'tl6':186, 'tl8':188, 'tl9':189, 'fm10':10}
    ...
    def generateDataC(self):
        ...
        if os.path.isfile(dataName) is False:
            ...
            DataGenerator.GenDataFile(self.args.InFolder,self.args.Simulator)
