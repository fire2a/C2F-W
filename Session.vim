...
noremap  k <Plug>(ale_find_references)
nnoremap  n :set nu! rnu!
vnoremap  c :PasteToIpython
vnoremap  v "+y :call term_sendkeys(g:terminal_buffer, '%paste')
vnoremap  x :SendToTerm
nnoremap  x :SendToTerm
...
vnoremap \p "+gP
vnoremap \y y :execute('!tmux paste-buffer -p -t {last} \; send-keys -t {last} Enter Enter') 
nnoremap \\\ :execute 'source ~/.vim/vimrc' | echo "Reloaded vimrc"
...
imap  <Plug>(ale_show_completion_menu)
let &cpo=s:cpo_save
unlet s:cpo_save
set background=dark
...
set ruler
set runtimepath=~/.vim,~/.vim/pack/plugin/start/vim-fugitive,~/.vim/pack/plugin/start/tagbar,~/.vim/pack/plugin/start/fzf,~/.vim/pack/plugin/start/ale,~/.vim/pack/github/start/copilot_vim,~/.vim/pack/color/start/everforest,~/.vim/pack/plugin/opt/vim-tmux-clipboard,~/.vim/pack/color/opt/csexact,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim90,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/after
set scrolloff=3
set smartcase
set splitbelow
set splitright
set statusline=%<%f\ %h%m%r%{fugitive#statusline()}%=%-14.(%l,%c%V%)\ %P%=\ %{LinterStatus()}
...
badd +1 Cell2Fire/makefile
badd +1 Cell2Fire/makefile.khipu
badd +1 Cell2Fire/makefile.macos
badd +1 Cell2Fire/makefile.macos-13
badd +1 Cell2Fire/makefile.macos-latest
badd +1 .github/workflows/buildmacos-13.yml
badd +1 .github/workflows/buildmacos-latest.yml
badd +1 .github/workflows/buildrelease.yml
badd +1 .github/workflows/buildubuntu-latest.yml
badd +1 .github/workflows/buildwindows.yml
badd +1 .github/workflows/build-debian-stable.yml
argglobal
%argdel
$argadd Cell2Fire/makefile
$argadd Cell2Fire/makefile.debian
$argadd Cell2Fire/makefile.khipu
$argadd Cell2Fire/makefile.macos
$argadd Cell2Fire/makefile.macos-13
$argadd Cell2Fire/makefile.macos-latest
$argadd Cell2Fire/makefile.ubuntu-latest
$argadd .github/workflows/buildmacos-13.yml
$argadd .github/workflows/buildmacos-latest.yml
$argadd .github/workflows/buildrelease.yml
$argadd .github/workflows/buildubuntu-latest.yml
$argadd .github/workflows/buildwindows.yml
$argadd .github/workflows/deletecachesgh.yml
edit Cell2Fire/makefile
argglobal
balt Cell2Fire/makefile.macos
setlocal keymap=
setlocal noarabic
