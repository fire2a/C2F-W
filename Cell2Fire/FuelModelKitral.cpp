...
std::unordered_map<int, std::vector<string>> ctgry;
...
setup_const()
{
    ...
    ctgry.insert(std::make_pair(PCH1, ctgry_pch1));
    ...
    ctgry.insert(std::make_pair(PCH2, ctgry_pch2));
    ...
    ctgry.insert(std::make_pair(PCH3, ctgry_pch3));
    ...
    ctgry.insert(std::make_pair(PCH4, ctgry_pch4));
    ...
    ctgry.insert(std::make_pair(PCH5, ctgry_pch5));
    ...
    ctgry.insert(std::make_pair(MT01, ctgry_mt01));
    ...
    ctgry.insert(std::make_pair(MT02, ctgry_mt02));
    ...
    ctgry.insert(std::make_pair(MT03, ctgry_mt03));
    ...
    ctgry.insert(std::make_pair(MT04, ctgry_mt04));
    ...
    ctgry.insert(std::make_pair(MT05, ctgry_mt05));
    ...
    ctgry.insert(std::make_pair(MT06, ctgry_mt06));
    ...
    ctgry.insert(std::make_pair(MT07, ctgry_mt07));
    ...
    ctgry.insert(std::make_pair(MT08, ctgry_mt08));
    ...
    ctgry.insert(std::make_pair(BN01, ctgry_bn01));
    ...
    ctgry.insert(std::make_pair(BN02, ctgry_bn02));
    ...
    ctgry.insert(std::make_pair(BN03, ctgry_bn03));
    ...
    ctgry.insert(std::make_pair(BN04, ctgry_bn04));
    ...
    ctgry.insert(std::make_pair(BN05, ctgry_bn05));
    ...
    ctgry.insert(std::make_pair(PL01, ctgry_pl01));
    ...
    ctgry.insert(std::make_pair(PL02, ctgry_pl02));
    ...
    ctgry.insert(std::make_pair(PL03, ctgry_pl03));
    ...
    ctgry.insert(std::make_pair(PL04, ctgry_pl04));
    ...
    ctgry.insert(std::make_pair(PL05, ctgry_pl05));
    ...
    ctgry.insert(std::make_pair(PL06, ctgry_pl06));
    ...
    ctgry.insert(std::make_pair(PL07, ctgry_pl07));
    ...
    ctgry.insert(std::make_pair(PL08, ctgry_pl08));
    ...
    ctgry.insert(std::make_pair(PL09, ctgry_pl09));
    ...
    ctgry.insert(std::make_pair(PL10, ctgry_pl10));
    ...
    ctgry.insert(std::make_pair(PL11, ctgry_pl11));
    ...
    ctgry.insert(std::make_pair(DX01, ctgry_dx01));
    ...
    ctgry.insert(std::make_pair(DX02, ctgry_dx02));
}
