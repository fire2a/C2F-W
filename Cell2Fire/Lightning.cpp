...
int
Lightning::Lambda_Simple_Test(int period)
{
...
bool
Lightning::Lambda_NH(int period, bool verbose)
{
    double fire_rate = 0.5;
    double alfa_fact = 0.1;
    double poisson_mean
        = (fire_rate / 2.0) * (2.0 + alfa_fact * ((period * period) - (period - 1) * (period - 1) - 2.0));
...
bool
Lightning::Lambda_H(int period, bool verbose)
{
