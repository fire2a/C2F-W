...
public:
  ...
  void printASCII(int rows, int cols, double xllcorner, double yllcorner,
                  int cellside, std::vector<float> statusCells);
  void printASCIIInt(int rows, int cols, double xllcorner, double yllcorner,
                     int cellside, std::vector<int> statusCells);
  void asciiHeader(int rows, int cols, double xllcorner, double yllcorner,
                   int cellside);
