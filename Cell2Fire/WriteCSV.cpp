...
void
CSVWriter::asciiHeader (int rows, int cols, double xllcorner, double yllcorner,
                        int cellside)
{
  std::fstream file;
  // Open the file in truncate mode if first line else in Append Mode
...
void
CSVWriter::printASCII (int rows, int cols, double xllcorner, double yllcorner,
...
void
CSVWriter::printASCIIInt (int rows, int cols, double xllcorner,
