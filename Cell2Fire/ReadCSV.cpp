...
/*
 * Populates vector of size NCells with type number based on lookup table (Spain
 * version)
 */
 ...
 */
void CSVReader::parseWeatherDF(weatherDF *wdf_ptr, arguments *args_ptr,
                               std::vector<std::vector<std::string>> &DF,
                               int WPeriods) {
  int i;
